...
public class ServerResponse<T> implements Serializable {
    ...
    private ServerResponse (int status, String msg, T data, List<T> dataList){
    	this.status = status;
        this.msg = msg;
        this.data = data;
        this.dataList = dataList;
    ...
    public static <T> ServerResponse<T> createBySuccessList(String msg, List<T> dataList) {
    	return new ServerResponse<T>(ResponseCodeEnum.SUCCESS.getCode(), msg, dataList);
    }
    
    public static <T> ServerResponse<T> createBySuccessList(int code, String msg, List<T> dataList) {
    	return new ServerResponse<T>(code, msg, dataList);
    }
    
    public static <T> ServerResponse<T> createBySuccess(String msg, T data, List<T> dataList) {
    	return new ServerResponse<T>(ResponseCodeEnum.SUCCESS.getCode(), msg, data, dataList);
    }
